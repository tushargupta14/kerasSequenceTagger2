...
def convert_Y_dict() :
	...
	for k,v in sentence_Y_dict.iteritems() :

		label_list = [label_dict[el] for el in v]
		sentence_Y_dict[k] = label_list

	with open("data/sentence_Y_dict.json","wb++") as  f:
		json.dump(sentence_Y_dict,f)
